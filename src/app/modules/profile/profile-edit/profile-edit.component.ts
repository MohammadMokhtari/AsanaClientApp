...
export class ProfileEditComponent implements OnInit, OnDestroy {
  ...
  public accountModel: ProfileModel | null;
  ...
  public onSubmit() {
    this.isLoading = true;
    const accountRequestModel: ProfileUpdateRequestModel =
      new ProfileUpdateRequestModel(
  ...
  private updateEditForm(accountModel: ProfileModel) {
